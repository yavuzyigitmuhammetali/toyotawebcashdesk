...
function Receipt({ storeName = "Lorem Ipsum", data = {} }) {
    ...
    return (
        <div className="receipt-container">
            ...
            <div className="receipt-main">
                {validatedData.cart.map((item, key) => (
                    <div key={key} className="receipt-product">
                        ...
                        <span>
                            {item.quantity} {item.fraction ? "klg." : "adt."}
                        </span>
            ...
            <div className="receipt-footer">
                <hr />
                <div>
                    <span>TPLKDV:</span> <span>*{validatedData.totalTax.toFixed(2)}$</span>
                </div>
                <div>
                    <span>TOPLAM:</span> <span>*{validatedData.total.toFixed(2)}$</span>
                </div>
                <hr />
                <br />
                ...
                <br />
                <div>
                    <span>ÖDENTPLM:</span> <span>*{validatedData.amountPaid.toFixed(2)}$</span>
                </div>
                <div>
                    <span>PARAÜSTÜ:</span> <span>*{validatedData.change.toFixed(2)}$</span>
                </div>
            </div>
