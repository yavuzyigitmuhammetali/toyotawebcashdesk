...
function LoginPageLeftArea({width = "401px", warn = false}) {
    const {isOnline, status, lang, dark, performanceMode, colorOptions} = useContext(AppStatusContext);
    const {t} = useTranslation();

    return (
        <div className="login-page-left-area-container" style={{width}}>
            ...
            <LoginSrc
                waveColor={colorOptions.loginLeft.waveColor}
                backgroundColor={colorOptions.loginLeft.backgroundColor}
                className={warn ? 'warn' : ''}
                dark={dark}
            />
