...
function MainScreenItem({children, customIcon, color = "#3D526D", dark = false, to}) {
    ...
    return (
        <Link to={to} style={{
            ...
            color: dark ? "white" : "#111418",
            borderColor: dark ? "white" : "black",
            textDecoration: "none"
        }} className="main-screen-item-container">
            <div style={{backgroundColor: color, filter: dark ? "brightness(1)" : "brightness(1.7)"}}
                 className="main-screen-item-icon">
                <IconComponent/>
            </div>
