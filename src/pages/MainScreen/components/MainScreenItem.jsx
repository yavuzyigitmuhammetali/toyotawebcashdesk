...
function MainScreenItem({children,customIcon,color="#3D526D",dark=true}) {
    const IconComponent = customIcon || CurrencyBitcoinIcon;
    return (
        <div style={{backgroundColor:dark?"#1E1E1E":"white",color:dark?"white":"#111418",borderColor:dark?"white":"white"}} className="main-screen-item-container">
